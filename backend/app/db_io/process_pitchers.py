    ...
    for raw in reader:
      try:
        ...
        stats = PitcherDailyStats(
          ...
          singles=parse_int_or_zero(raw["p_h"]),
          ...
          win_p=parse_int_or_zero(raw["wp"]),
          lose_p=parse_int_or_zero(raw["lp"]),
          sv=parse_int_or_zero(raw["save"]),
          gs=parse_int_or_zero(raw["p_gs"]),
